...
foreach ($utilisateur in $utilisateurs) {
   ...
   # Définition de l'OU de destination (à adapter selon votre AD)
    ...
    # Création du compte utilisateur dans l'Active Directory
        ...
        Write-Host "L'utilisateur $nomComplet a été créé avec succès avec le mot de passe initial : $passwordPlain" -ForegroundColor Green

        # Affectation de l'utilisateur à un groupe correspondant à son service
        # Supposons que le nom du groupe est identique au service renseigné dans le CSV
